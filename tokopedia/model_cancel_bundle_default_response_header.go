...
// checks if the CancelBundleDefaultResponseHeader type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelBundleDefaultResponseHeader{}
...
func NewCancelBundleDefaultResponseHeader() *CancelBundleDefaultResponseHeader {
	this := CancelBundleDefaultResponseHeader{}
	return &this
}
...
type NullableCancelBundleDefaultResponseHeader struct {
	value *CancelBundleDefaultResponseHeader
	isSet bool
}

func (v NullableCancelBundleDefaultResponseHeader) Get() *CancelBundleDefaultResponseHeader {
	return v.value
}

func (v *NullableCancelBundleDefaultResponseHeader) Set(val *CancelBundleDefaultResponseHeader) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelBundleDefaultResponseHeader) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelBundleDefaultResponseHeader) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelBundleDefaultResponseHeader(val *CancelBundleDefaultResponseHeader) *NullableCancelBundleDefaultResponseHeader {
	return &NullableCancelBundleDefaultResponseHeader{value: val, isSet: true}
}

func (v NullableCancelBundleDefaultResponseHeader) MarshalJSON() ([]byte, error) {
