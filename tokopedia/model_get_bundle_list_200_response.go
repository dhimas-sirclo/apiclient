...
// checks if the GetBundleList200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBundleList200Response{}
...
func (o *GetBundleList200Response) GetData() GetBundleList200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret GetBundleList200ResponseData
		return ret
	}
	return *o.Data
}
...
type NullableGetBundleList200Response struct {
	value *GetBundleList200Response
	isSet bool
}

func (v NullableGetBundleList200Response) Get() *GetBundleList200Response {
	return v.value
}

func (v *NullableGetBundleList200Response) Set(val *GetBundleList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBundleList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBundleList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBundleList200Response(val *GetBundleList200Response) *NullableGetBundleList200Response {
	return &NullableGetBundleList200Response{value: val, isSet: true}
}
