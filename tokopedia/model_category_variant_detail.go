...
type CategoryVariantDetail struct {
	...
	HasUnit *int32 `json:"has_unit,omitempty"`
...
// SetHasUnit gets a reference to the given int32 and assigns it to the HasUnit field.
...
// SetIsPrimary gets a reference to the given int32 and assigns it to the IsPrimary field.
